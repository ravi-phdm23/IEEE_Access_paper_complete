...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{Anju_maam.jpg}}]{Dr. Anju Goswami} received the Ph.D. degree in Financial Economics from the Indian Institute of Technology (IIT) Roorkee, India. She is currently an Assistant Professor in the Department of Finance at the Indian Institute of Foreign Trade (IIFT), New Delhi. Her research interests include credit risk, non-performing assets, banking efficiency, financial regulation, sustainability, and the application of econometric and data-driven methods in banking and financial systems.
\end{IEEEbiography}
